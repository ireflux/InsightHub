...
async def run_cli():
    ...
    try:
        ...
        engine = InsightEngine(
            ...
            editorial_brief_prompt=settings.prompt.editorial.brief,
            editorial_cluster_prompt=settings.prompt.editorial.cluster,
            editorial_review_prompt=settings.prompt.editorial.review,
            editorial_revision_prompt=settings.prompt.editorial.revision,
            scoring_prompt=settings.prompt.scoring.llm_score,
